...
import 'package:e_commerce/widget/carousel_slider.dart';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () {
                          Go.named(context, RouteName.homeSearchScreen);
                        },
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Go.named(context, RouteName.categoryScreen);
                          },
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    GestureDetector(
                      onTap: () {
                        Go.named(context, RouteName.flashSaleScreen);
                      },
                      child: Row(
                        children: [
                          const CustomText(
